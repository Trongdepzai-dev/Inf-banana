...
export const LandscapeIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const GeneratorIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3v.01"/>
        <path d="M16.2 3.8l.01.01"/>
        <path d="M19.4 6.6l.01.01"/>
        <path d="M21 12h.01"/>
        <path d="M19.4 17.4l.01.01"/>
        <path d="M16.2 20.2l.01.01"/>
        <path d="M12 21v.01"/>
        <path d="M7.8 20.2l-.01.01"/>
        <path d="M4.6 17.4l-.01.01"/>
        <path d="M3 12h-.01"/>
        <path d="M4.6 6.6l-.01.01"/>
        <path d="M7.8 3.8l-.01.01"/>
    </svg>
);

export const DownloadIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4 4-4-4m4 4V4" />
  </svg>
);
...
export const MagicWandIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4m-3 10v4m-2-2h4m10-3v4m-2-2h4m-3-10v4m-2-2h4" />
    </svg>
);
...
export const StarIcon: React.FC<StarIconProps> = ({ className = "w-5 h-5", fill, half, full }) => {
    let fillValue = "none";
    if (full || fill) fillValue = "currentColor";

    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={fillValue} stroke="currentColor" strokeWidth={1.5}>
            {half ? (
                <>
...
export const FilmIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75-3.75v3.75m-3.75-3.75h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v11.25A2.25 2.25 0 004.5 20.25z" />
    </svg>
);

export const PaintBrushIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a2.25 2.25 0 012.245-2.4 3 3 0 001.128-5.78 4.5 4.5 0 00-2.245 8.4c-.78 0-1.533-.078-2.245-.22a15.998 15.998 0 00-1.62-3.388m-5.043-.025a15.998 15.998 0 013.388-1.622m0 0a2.25 2.25 0 012.4 2.245 3 3 0 005.78-1.128 4.5 4.5 0 00-8.4 2.245c0 .399.078.78.22 1.128a15.998 15.998 0 001.62 3.388z" />
    </svg>
);
